...
class ReviewBookingPage extends StatelessWidget {
  ...
  Future<void> _processBooking(BuildContext context) async {
    try {
      final result = await SignupAPI.bookFastService(
      ...
      if (result["success"] == true) {
        ...
        ScaffoldMessenger.of(context).showSnackBar(
          SnackBar(content: Text("Booking failed: ${result["message"] ?? "Try again!"}")),
        );
      }
    } catch (e) {
      ScaffoldMessenger.of(context).showSnackBar(
        ...
        child: Column(
          ...
          children: [
            ...
            if (problemImage != null) ...[
              ...
              Image.file(problemImage!, width: 120, height: 120, fit: BoxFit.cover),
            ],
